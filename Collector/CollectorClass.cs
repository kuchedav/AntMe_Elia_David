...
namespace AntMe.Player.Test
{
    [Player(
        ColonyName = "0_Collector",
        FirstName = "David",
        LastName = "Kuchelmeister"
    )]
    [Caste(
        Name = "Default",
        AttackModifier = -1,
    ...
    public class TestClass : BaseAnt
    {
        ...
        {
            if (this.CarryingFruit == null)
            {
                this.GoToDestination(fruit);
            }
        }
        ...
        public override void DestinationReached(Fruit fruit)
        {
            ...
            {
                MakeMark((int)MarkerTypes.Fruit, 200);
                this.Take(fruit);
                GoToAnthill();
            }
            else
        ...
        {
            MakeMark((int)MarkerTypes.Sugar, 200);
            this.Take(sugar);
            GoToAnthill();
        }
        ...
        {
            if ((int)MarkerTypes.Fruit == 1 && this.CurrentLoad == 0)
            {
                GoToDestination(marker);
            }
            if ((int)MarkerTypes.Sugar == 0 && this.CurrentLoad == 0)
            {
                GoToDestination(marker);
            }
        }
