...
namespace AntMe.Player.EliaDavid
{
    [Player(
        ColonyName = "EliaDavid",
        FirstName = "David",
        LastName = "Antmeister"
    )]
    [Caste(
    ...
    public class FirstStepsAnts : BaseAnt
    {

        #region Custom

        public enum MarkerTypes { Sugar, Fruit, Enemy };
        ...
        {
            if (this.Destination is Food || this.Destination is Anthill)
            {
                return;
            }
            GoToAnthill();
        ...
        {
            if (this.CurrentLoad == 0 && this.NeedsCarrier(fruit) && this.Destination != null)
            {
        ...
        {
            if (this.CurrentLoad == 0 && this.Destination != null)
            {
        ...
        {
            Take(sugar);
            MakeMark((int)MarkerTypes.Sugar, 300);
            GoToAnthill();
        }
        ...
        {
            if (marker.Information == (int)MarkerTypes.Sugar && this.Destination == null)
            {
